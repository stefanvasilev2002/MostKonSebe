                ...
                sections: [
                    {
                        ...
                        content: 'Менталното здравје вклучува емоционална, психолошка и социјална благосостојба. Тоа влијае на тоа како мислиме, чувствуваме и постапуваме.'
                    },
                    {
                        title: 'Зошто е важно?',
                ...
                <div className="bg-white border rounded-lg p-4 shadow-sm">
                    ...
                    <div className="space-y-3 text-sm">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="font-medium">Емоционална благосостојба</p>
